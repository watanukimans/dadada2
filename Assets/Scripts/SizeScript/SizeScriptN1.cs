...
public class SizeScriptN1 : MonoBehaviour
{
    ...
    void OnMouseEnter()
    {
        ...
        righteye.transform.localScale = new Vector3(
            righteye.transform.localScale.x * 0.9f,
            righteye.transform.localScale.y * 0.9f,
            righteye.transform.localScale.z
        );
        lefteye.transform.localScale = new Vector3(
            lefteye.transform.localScale.x * 0.9f,
            lefteye.transform.localScale.y * 0.9f,
