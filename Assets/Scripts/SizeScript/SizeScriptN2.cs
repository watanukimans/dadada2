...
public class SizeScriptN2 : MonoBehaviour
{
    ...
    void OnMouseEnter()
    {
        ...
        righteye.transform.localScale = new Vector3(
            righteye.transform.localScale.x * 0.8f,
            righteye.transform.localScale.y * 0.8f,
            righteye.transform.localScale.z
        );
        lefteye.transform.localScale = new Vector3(
            lefteye.transform.localScale.x * 0.8f,
            lefteye.transform.localScale.y * 0.8f,
